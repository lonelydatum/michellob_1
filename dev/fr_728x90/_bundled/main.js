...
function start() {
	...
	tl.set(".frame1", { backgroundColor: _commonJs.BLUE });
	tl.add(setItem("w"));
	...
	tl.add("toRed", "+=" + FLASH);
	tl.set(".frame1", { backgroundColor: _commonJs.RED }, "toRed");
...
var _commonJsLbJs = require('../../_common/js/lb.js');

module.exports = {};

},{"../../_common/js/lb.js":2}]},{},[3])
